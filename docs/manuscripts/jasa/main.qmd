...
The complete model summary and the short-lag stop comparison are available in @tbl-mono and @fig-bilinguals-d-t of the supplementary materials.
...
Similar to monolingual data, skewness and kurtosis paterned similarly, as did COG and standard deviation. 
...
In this case, however, the outcome variables were modeled as a function of language (POA: English, Spanish), place of articulation (bilabial, coronal), standardized F1 and F2, and item repetitions. 
We only included the voiceless stops (/p/, /t/) from each language. 
Importantly, the fixed effect *POA* is a within-participant factor. 
...
For all plots, the y-axis represents the outcome variable in standardized unites, the x-axis represents POA, and language is represented by color. 
