...
**Voice-onset time.** VOT for English stops was higher than for Spanish stops `r report_posterior(bi_table, param = "Language", metric = "VOT")`, as was the case for voiceless segments in comparison with voiced segments `r report_posterior(bi_table, param = "Phoneme", metric = "VOT")`.
The two predictors did not interact `r report_posterior(bi_table, param = "Language:Phoneme", metric = "VOT")`.
...
There was no evidence for a group effect `r report_posterior(bi_table, param = "Language", metric = "RI")`, nor for phoneme `r report_posterior(bi_table, param = "Phoneme", metric = "RI")` or F2 effects `r report_posterior(bi_table, param = "F2", metric = "RI")`.
We found a relationship between height of the following /a/ and relative intensity of the burst  `r report_posterior(bi_table, param = "F1", metric = "RI")`. 
Concretely, higher F1 values were associated with lower relative intensity.
There was no evidence supporting a language &times; phoneme interaction `r report_posterior(bi_table, param = "Language:Phoneme", metric = "RI")`.
...
Voiceless segments had higher COG than the voiced segments `r report_posterior(bi_table, param = "Phoneme", metric = "COG")`. 
We found weak evidence for a language &times; phoneme `r report_posterior(bi_table, param = "Language:Phoneme", metric = "COG")`.
