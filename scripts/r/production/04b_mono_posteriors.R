...
bind_rows(
  ...
  mutate(metric = fct_relevel(metric, "VOT", "RI"),
         parameters = fct_relevel(parameters,
          "b_group_sum:phon_sum:stress_sum", "b_phon_sum:stress_sum",
          "b_group_sum:stress_sum", "b_group_sum:phon_sum", "b_rep_n",
          "b_stress_sum", "b_phon_sum", "b_group_sum", "b_Intercept")) %>%
